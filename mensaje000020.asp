...
<BODY Background="back2.jpg" vlink="black" link="black"><CENTER>
<FORM METHOD=Post ACTION=Ejemplo5a.asp>
  <H4 align="center" class="style1"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">(20) 
    Ticket no encontrado</font></H4>
  <H4 align="center" class="style1">&nbsp;</H4>
</FORM>

<div align="center"> 
  <div id="Layer4" style="position:absolute; left:463px; top:96px; width:74px; height:28px; z-index:5"> 
