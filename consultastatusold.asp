...
<FORM METHOD="Post" name="consultastatus" ACTION="consultastatus.asp">
  ...
  <div align="center"> 
    <div id="Layer1" style="position:absolute; width:245px; height:97px; z-index:1; left: 362px; top: 38px;"> 
      ...
      <table width="100%" border=0>
        <tr> 
          <td width="70" class="style5"><strong>CEDULA&nbsp; </strong>
          <td width="165" class="style1"><strong> 
            <input name="Cedula" class="style2" size="14">
            </strong> 
        <tr> 
          <td height="27" colspan=2 class="style1"><strong><font size="2">CARTA 
            AVAL</font> 
