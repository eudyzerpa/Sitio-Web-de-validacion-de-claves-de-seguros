...
var p1='';
var p2='';
p2=document.consultastatus.Cedula.value
p=document.consultastatus.Cedula.value
p=p.replace("CIV","")
p=p.replace("CIE","")
n=p.length;
n=9-n;
...
for (var i = 1; i < n+1 ; i++)
p1=p1.replace(" ","");
//document.consultastatus.cedula.value=p2.substring(0,3)  + p1 + p;
document.consultastatus.cedula.value= p1 + p;
}
</script>
</HEAD>
<BODY BGCOLOR=FFFFFF>
    ...
    <div id="Layer1" style="position:absolute; width:245px; height:115px; z-index:1; left: 362px; top: 67px;"> 
      ...
      <table width="100%" border=0>
        <tr> 
          ...
          <td width="165" class="style1"><input name="Cedula" onblur="Validateci()" class="style2" size="9"> 
        <tr> 
